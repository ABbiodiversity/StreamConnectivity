# ---
# title: "Stream parameter functions"
# author: "Brandon Allen"
# created: "2025-01-11"
# notes: 
#   "Functions and associated wrappers for calculating local stream parameters."
# ---

#' [Stream confluence]
#'
#' [Wrapper function of the steam slope function used for calculating confluence bounded slope]
#'
#' @param [watershed.path] [File path for the network.]
#' @return [Saves stream confluence parameters to the network files]
#' 
...
#' [Stream slopes]
#'
#' [Function for calculating the stream slope (confluence or reach) using the base network files]
#'
#' @param [culvert.id] [Individual culvert id.]
#' @param [culvert.list] [List of potential culverts.]
#' @param [node.data] [Node data frame.]
#' @param [edge.data] [Edge data frame.]
#' @param [slope.type] [Slope type, confluence or reach.]
#' @return [Returns stream slope.]
#' 
...
#' [Stream distance]
#'
#' [Wrapper function of the upstream distance function.]
#'
#' @param [watershed.path] [File path for the network.]
#' @return [Saves upstream distance parameters to the network files]
#' 
...
#' [Upstream distance]
#'
#' [Calculates total upstream distance from any point and repairs the stream network]
#'
#' @param [culvert.id] [Individual culvert id.]
#' @param [node.network] [Node data frame.]
#' @param [edge.network] [Edge data frame.]
#' @return [Returns the upstream distance associated with that culvert.]
#' 
